...
test.describe("Tracking Link Generator", () => {
	...
	test("moves query params found after # into the URL's search params", async () => {
		await trackingPage.goto();
	...
	test("auto-adds https:// scheme when the input has no protocol", async () => {
		await trackingPage.goto();
	...
	test("supports https: links (allow-listed protocol)", async () => {
		await trackingPage.goto();
	...
	test("supports http: links (allow-listed protocol)", async () => {
		await trackingPage.goto();
	...
	test("supports mailto: links (allow-listed protocol)", async () => {
		await trackingPage.goto();
	...
	test("supports fb-messenger: links (allow-listed protocol)", async () => {
		await trackingPage.goto();
	...
	test("produces empty output for an unsupported protocol", async () => {
		await trackingPage.goto();
	...
	test('should show the live link preview in the "Tracking link preview" region', async () => {
		await trackingPage.goto();
		await trackingPage.enterTrackingUrl("https://act.example.org/petition");
	...
	test('should show the copy-friendly link in the "Tracking link output" region', async () => {
		await trackingPage.goto();
		await trackingPage.enterTrackingUrl("https://act.example.org/petition");
	...
	test("should keep the preview and output links in sync", async () => {
		await trackingPage.goto();
		await trackingPage.enterTrackingUrl("https://act.example.org/petition");
