...
import { setupConsoleErrorTracking, testData } from './helpers/test-utils';
...
test.describe('Clean HTML Tool', () => {
  ...
  test.describe('HTML Processing Workflow', () => {
    test('should process simple HTML and show output', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should remove unwanted span and div tags', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should transform styled spans to semantic tags', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should clean up Google redirect URLs', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should prettify and format HTML output', async ({ page }) => {
      await cleanHtmlPage.goto();
  ...
  test.describe('Copy Functionality', () => {
    test('should enable copy button after processing', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should change copy button state when clicked', async ({ page }) => {
      await cleanHtmlPage.goto();
  ...
  test.describe('Start Again Functionality', () => {
    test('should return to initial state when start again is clicked', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should maintain focus on input after start again', async ({ page }) => {
      await cleanHtmlPage.goto();
  ...
  test.describe('Original HTML Details', () => {
    test('should show original HTML when details is expanded', async ({ page }) => {
      await cleanHtmlPage.goto();
  ...
  test.describe('Complex Real-World Examples', () => {
    test('should handle Word document paste with multiple issues', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should handle realistic Word document with extensive formatting', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should handle Google Docs document with extreme span nesting', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should handle Google Docs paste with simple formatting', async ({ page }) => {
      await cleanHtmlPage.goto();
  ...
  test.describe('Edge Cases and Error Handling', () => {
    test('should handle very large HTML input', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should handle HTML with special characters', async ({ page }) => {
      await cleanHtmlPage.goto();
    ...
    test('should handle script and style tags properly', async ({ page }) => {
      await cleanHtmlPage.goto();
